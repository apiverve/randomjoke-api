...
namespace APIVerve.API.RandomJoke
{
    /// <summary>
    ...
    /// <summary>
    /// Client for the RandomJoke API
    /// </summary>
    public class RandomJokeAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/randomjoke";
        ...
        public RandomJokeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RandomJokeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RandomJokeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RandomJokeQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RandomJokeQueryOptions options)
        {
        ...
        public ResponseObj Execute(RandomJokeQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RandomJokeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RandomJokeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RandomJokeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RandomJokeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RandomJokeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RandomJokeQueryOptions options)
        {
