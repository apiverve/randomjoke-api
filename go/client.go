// Package randomjoke provides a Go client for the Random Joke API.
//
// For more information, visit: https://apiverve.com/marketplace/randomjoke?utm_source=go&utm_medium=readme
package randomjoke
...
const (
	baseURL        = "https://api.apiverve.com/v1/randomjoke"
	defaultTimeout = 30 * time.Second
)

// Client is the Random Joke API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Random Joke API client.
...
// Execute makes a request to the Random Joke API.
